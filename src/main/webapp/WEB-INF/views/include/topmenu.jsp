...
<div id="menu">
    <div class="main-nav">
        ...
        <ul class="menuTitleBox">
            <li><a class="title" href="/guide/guide">이용안내</a></li>
        ...
        <ul class="menuTitleBox">
            <li><a class="title" href="/club/intro">클럽소개</a></li>
            <li><a href="/club/intro">소개</a></li>
            <li><a href="/club/greeting">인사말</a></li>
            <li><a href="/club/location">오시는길</a></li>
        </ul>
        <ul class="menuTitleBox">
            <li><a class="title" href="/couse/intro">코스소개</a></li>
        ...
        <ul class="menuTitleBox">
            <li><a class="title" href="/board/list">시설안내</a></li>
        ...
        <ul class="menuTitleBox">
            <li><a class="title" href="/board/list?type=1">정보마당</a></li>
