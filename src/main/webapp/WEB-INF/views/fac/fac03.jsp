...
<div id="wrap">
    ...
    <div class="contents">
        <ul class="facTitleBox">
            ...
            <li class="bigTt2 bold">포도CC 프로샵</li>
        </ul>
        <div class="padding20"></div>

        <div class="guideTxt">
            <p class="bold title2">PodoCC Pro Shop</p>
            <p class="bold title">고객의 품위에 맞게 다양하고 엄선된 최상의 골프용품을 제공합니다.</p>
        ...
        <div class="facSlide">
            ...
            <div class="bx-wrapper2">
                <ul class="slider2">
                    <li><img src="/static/images/P_01.jpg" title="프로샵"></li>
                    <li><img src="/static/images/P_02.jpg" title="프로샵"></li>
                    <li><img src="/static/images/P_03.jpg" title="프로샵"></li>
                </ul>
