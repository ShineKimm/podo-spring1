		...
		mAjax(sUrl, params, "POST", true, function(data) {
			if(data.resultCode = "0000") {
				...
				for(i=0; i<rows.length; i++) {
					...
					var td5 = $("<td>" + rows[i].MS_LAST_PHONE1 + "</td>");
					var td6 = $("<td>" + rows[i].MS_POINT_A_TOTAL + "</td>");
					var td7 = $("<td>" + rows[i].MS_POINT_B_TOTAL + "</td>");
					var td8 = $("<td>" + totalScore + "</td>");

					tr.append(td1,td2,td3,td4,td5,td6,td7,td8).appendTo(tbody);
...
<div class="contents">
	<ul class="commonTitle">
		<li class="title">스코어조회</li>
		<li class="midBar"></li>
	</ul>	
	
	<div class="searchTerm">
		<span class="stStyle">조회기간</span>
		<div class="reser_search wp35" id="calContainer1">
			<txt id="show_hideSub1"></txt>
			<span class="choiceCalendar2" id="show_calendar1"><img src="/mobile/images/img_c.png"></span>
			<div class="openCalendar2" id="subMonthBox1">
				<div class="smallCalendarTit sty1">
					<p class="arwl"><a href="javascript:smPrevMonth()">◀</a></p>
					<h3 id="calHeader"></h3>
					<p class="arwr"><a href="javascript:smNextMonth()">▶</a></p>
				</div>
		...
		<span class="stStyle">~</span>
		<div class="reser_search wp35" id="calContainer2">
			<txt id="show_hideSub2"></txt>
			<span class="choiceCalendar3" id="show_calendar2"><img src="/mobile/images/img_c.png"></span>
			<div class="openCalendar3" id="subMonthBox2">
				<div class="smallCalendarTit sty1">
					<p class="arwl"><a href="javascript:fmPrevMonth()">◀</a></p>
					<h3 id="calHeader"></h3>
					<p class="arwr"><a href="javascript:fmNextMonth()">▶</a></p>
				</div>
				<table class="sCalendar">
					<colgroup>
						<col width="13%">
	...
	<a href="javascript:doSearch()" class="btn-search">검색</a>
	
	<p class="score-text red font825">※ 시상품 지급(추후 연락 및 본인 일치 여부 확인)을 위해 사전 사이버회원에 가입부탁드립니다. </p>
	<table class="commonTable">
		...
		<thead>
			<tr>
				<th scope="col">순위</th>
				<th scope="col">내장<br>일자</th>
				<th scope="col">시간</th>
				<th scope="col">성명</th>
				<th scope="col">4자리</th>
				<th scope="col">전반<br>Score</th>
				<th scope="col">후반<br>Score</th>
				<th scope="col">합계</th>
			</tr>
		</thead>
		<tbody id="tbody">
