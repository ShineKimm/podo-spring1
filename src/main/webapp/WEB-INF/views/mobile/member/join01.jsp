...
$(document).ready(function() {
	...
	function init() {
		...
		for(i=1; i<=5; i++) {
			$(".agreeyBtn" + i).data("idx", i);
			$(".agreeyBtn" + i).click(function(){
				$(".joinTextarea_" + $(this).data("idx")).toggle();
			});

			$(".agBtn" + i).data("idx", i)
			$(".agBtn" + i).click(function(){
				$(".joinTextarea_" + $(this).data("idx")).toggle();
			});
		}
	}
...
<div class="contents">
	...
	<div class="agreeyBgBox">
		<ul class="joinAgreeyList">
			...
			<li class="arrowBtn"><div class="agreeyBtn1">▼</div></li>
			<li class="agreeyCheck"><label><input type="radio" name="chkAgree1" value="Y"> 동의</label> &nbsp;<label><input type="radio" name="chkAgree1" value="N"> 비동의</label></li>
		</ul>
		<div class="joinTextarea_1" style="display: none;">
			<div class="textarea" name="" id="">1.제 1 조 목적
...
본 정책의 내용에 관한 질문은 podocc2020@naver.com으로 하시기 바랍니다.
		...
		<!--<ul class="joinAgreeyList">
			<li class="agreeyTitle agBtn2">개인정보 수집 및 이용동의<span class="red">(필수)</span></li>
			<li class="arrowBtn"><div class="agreeyBtn2">▼</div></li>
			<li class="agreeyCheck"><label><input type="radio" name="chkAgree2" value="Y"> 동의</label> &nbsp;<label><input type="radio" name="chkAgree2" value="N"> 비동의</label></li>
		</ul>
		<div class="joinTextarea_2" style="display:none;">
			<div class="textarea" name="" id="">개인정보 수집 및 이용동의
※ 포도컨트리클럽 골프클럽 예약 서비스 제공을 위해서 필요한 최소한의 개인정보이므로 동의를 해 주셔야 서비스를 이용하실수 있습니다.

‘본 동의는 포도컨트리클럽 골프클럽의 본질적 기능 제공을 위한 개인정보 수집/이용에 대한 동의로서,고객님은 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있으며, 본 동의를 거부할 경우 받는 별도의 불이익은 없습니다.
단, 본 동의를 거부할 경우, 포도컨트리클럽 골프클럽의 서비스 이용이 불가능합니다.’
			</div>
		</div>-->
	</div>
	<p class="agreeTitle"><span class="brown">●</span>개인정보 수집 및 이용동의 (필수)</p>

	<table border="0" cellpadding="0" cellspacing="0" class="joinTable">
		<colgroup>
			<col width="40%">
			<col width="35%">
			<col width="25%">
	...
	<p class="calTxt">
		※ 포도컨트리클럽 골프클럽 예약 서비스 제공을 위해서 필요한 최소한의 개인정보이므로 동의를 해 주셔야 서비스를 이용하실수 있습니다.<br>
<br>
‘본 동의는 포도컨트리클럽 골프클럽의 본질적 기능 제공을 위한 개인정보 수집/이용에 대한 동의로서,
고객님은 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있으며, 본 동의를 거부할 경우 받는 별도의 불이익은 없습니다.<br>
단, 본 동의를 거부할 경우, 포도컨트리클럽 골프클럽의 서비스 이용이 불가능합니다.’
	</p>

	<p class="allAgree">
		<label><input type="radio" name="chkAgree2" value="Y">동의</label>
		<label><input type="radio" name="chkAgree2" value="N">비동의</label>
	</p>
	
	<p class="agreeTitle"><span class="brown">●</span>개인정보수집 및 이용동의 (선택)</p>
...
본 동의는 포도컨트리클럽 골프클럽의 서비스 제공을 위한 개인정보 수집/이용에 대한 동의로서, 고객님은 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있으며, 본 동의를 거부할 경우 받는 별도의 불이익은 없습니다.’<br>
<br>
...
- 고객이 본 수신동의를 철회하고자 할 경우 당사의 개인정보 취급 책임자/담당자를 통해 수신동의 철회요청을 할 수 있습니다.
	</p>
	
	<p class="allAgree">
		<label><input type="checkbox" name="chkAll" id="chkAgreeAll" onclick="onChangeAllAgree()"> 전체동의</label>
	</p>
