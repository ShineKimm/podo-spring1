...
<div class="contents">
	...
	<ul class="commonTitle">
		<li class="title">회원정보수정</li>
		<li class="midBar"></li>
	</ul>
	
	<p class="agreeTitle"><span class="brown">●</span>필수정보 입력 <button type="button" class="delete">회원탈퇴</button></p>
	<table class="joinTable" summary="회원가입 기본정보 입력">
		<caption>회원수정 - 기본정보 입력</caption>
		<colgroup>
			<col width="25%">
			<col width="75%">
		</colgroup>
		...
		<tbody>
			<tr>
				<th>이름</th>
				<td id="txtName">홍길동</td>
			</tr>
			<tr>
				<th>성별</th>
				<td><label><input type="radio" name="chkSex" id="" title="남자 선택" value="1"> 남</label> &nbsp;&nbsp;<label><input type="radio" name="chkSex" id="" title="여자 선택" value="2"> 여</label></td>
			</tr>
			<tr>
				<th>아이디</th>
				<td id="txtId"></td>
			...
			<tr>
				<th>비밀번호 확인</th>
				<td><input type="password" name="txtPwConfirm" id="txtPwConfirm" title="비밀번호 확인" maxlength="20">
				<span id="txtPwConfirmMsg" class="red" style="; line-height:30px;" hidden>비밀번호가 일치하지 않습니다.</span></td>
			</tr>
			<tr>
				<th>생년월일</th>
				<td>
					<input type="input" name="txtBirth" id="txtBirth" title="연도 선택" class="phIp" maxlength="8" placeholder="ex)19810101" onkeydown="onlyNumber(this)">
					<label><input type="radio" name="chkBirth" id="" title="양력 선택" value="1" checked> 양력</label> &nbsp;&nbsp;<label><input type="radio" name="chkBirth" id="" title="음성 선택" value="2"> 음력</label>
				</td>
			</tr>
			<tr>
				<th>지역</th>
