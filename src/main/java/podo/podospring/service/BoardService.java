...
@Service
public class BoardService extends AbstractDAO {
    ...
    public HashMap<String, Object> writeBoard(HashMap<String, Object> params) throws ReturnException {
        try{
            int errNum = 0;
    ...
    @SuppressWarnings("unchecked")
    @Transactional(rollbackFor = {Exception.class})
    public HashMap<String, Object> writeReply(HashMap<String, Object> params) throws ReturnException{
        try{
